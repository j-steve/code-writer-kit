...
- **Style Guide Enforcement**: The primary purpose of the `code_writer` subagent is to strictly enforce repository code style, top-down ordering, modularity, explicit parameter passing, additive docstrings, and quality standards.
