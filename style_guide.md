...
1. **Top-Down Sequential Ordering & Modularity**:
   ...
   - Break complex logic into smaller, single-purpose helper functions, but do not artificially fragment coherent, readable algorithms solely to satisfy line limits.

2. **Don't Repeat Yourself (DRY) & Cross-Module Sharing**:
...
5. **Context-Rich Documentation (Additive Docstrings)**:
...
6. **Direct Expressions & Inline Flow**:
...
7. **Avoid Magic Numbers, Constants & Structured Enums**:
